...
function () {
  ...
  ClientesComponent.prototype.carregarClientes = function () {
    ...
    this.clienteService.getAll().subscribe(function (result) {
      ...
      _this.dataSource.data = _this.clientes; // this.dataSource.paginator = this.paginator;
  ...
  __decorate([core_1.ViewChild(paginator_1.MatPaginator)], ClientesComponent.prototype, "paginator");

  __decorate([core_1.ViewChild(sort_1.MatSort)], ClientesComponent.prototype, "sort");

  ClientesComponent = __decorate([core_1.Component({
    selector: 'app-clientes',
    imports: [navbar_component_1.NavbarComponent, footer_component_1.FooterComponent, forms_1.FormsModule, form_field_1.MatFormFieldModule, input_1.MatInputModule, table_1.MatTableModule, sort_1.MatSortModule, paginator_1.MatPaginatorModule, button_1.MatButtonModule, loading_blue_component_1.LoadingBlueComponent, common_1.NgIf],
